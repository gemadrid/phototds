...
public class VentanaPrincipal extends JFrame {
	...
	//Crear panel subir
	private JPanel crearPanelSubir() {
		JPanel panelSubir = new JPanel();
		panelSubir.setBackground(fondo);
		
		JLabel lblSubir = new JLabel("Panel Subir");
		lblSubir.setForeground(Color.WHITE);
		lblSubir.setFont(new Font("Poppins Black", Font.PLAIN, 20));
		panelSubir.add(lblSubir);
	...
	private JPanel crearPanelBuscar() {
		...
		JLabel lblBuscar = new JLabel("Panel Buscar");
		lblBuscar.setForeground(Color.WHITE);
		lblBuscar.setFont(new Font("Poppins Black", Font.PLAIN, 20));
